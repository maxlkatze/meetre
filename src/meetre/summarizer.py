...
_DEFAULT_INSTRUCTION = {
    "de": "Erstelle eine konkrete, inhaltsreiche Zusammenfassung des Meetings. "
          ...
          "- Passe die Länge dem Gespräch an. Ein kurzes oder beiläufiges "
          "Gespräch ergibt wenige Stichpunkte — blähe es nicht künstlich auf und "
    ...
    "en": "Write a concrete, substantive summary of the meeting. Write so that "
          ...
          "- Match the length to the conversation. A short or casual chat yields "
          "a few bullets — do not pad it or repeat the same point across "
          "sections.\n"
